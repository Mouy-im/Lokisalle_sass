...
<div id="reservation" class="conteneur py-5">
  <h1>Recherche</h1>
    <div class="row">
        <div class='col-12 col-md-8 bg-light shadow mx-auto p-5'>
            <h2 class="h4 text-center">Recherche d'une location de salle pour réservation</h2>
            <form method="post" action="">
                <div class="row text-center mt-5">
                    <div class="col-6 text-center">
                        <div class="mb-3 text-center">
                            <label for="date" class="form-label">À partir du :</label>
