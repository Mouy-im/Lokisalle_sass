...
<div class="container-fluid">
  <div class="row mx-auto ">
    ...
    <div class="col-12 col-md-4 my-5 mx-auto bg-light p-5">
        ...
        <div class="row mx-2">
<?php
$resultat = $pdo->query('SELECT * FROM produit,salle WHERE produit.id_salle = salle.id_salle AND produit.etat = 1 AND produit.date_arrivee > NOW() ORDER BY salle.id_salle DESC LIMIT 3');
